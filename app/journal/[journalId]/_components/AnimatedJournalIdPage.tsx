...
type JournalIdPageProps = {
  journals: Journal[];
  journal: Journal;
  articles: Journal["article_content"];
};
const AnimatedJournalIdPage: FC<JournalIdPageProps> = ({
  journals,
  journal,
  articles,
}) => {
  const titleRef = useRef<HTMLElement>(null);
  const articleMetaRef = useRef<HTMLElement>(null);
  ...
  useGSAP(() => {
    ...
    tl.from(titleRef.current, {
      ...
      .from(articleMetaRef.current, {
        autoAlpha: 0,
        y: "80px",
      })
      .from(articleDetailsRef.current, {
        autoAlpha: 0,
        y: "80px",
      });
  });
  return (
    <>
      <header
        ref={titleRef}
        className="invisible mx-auto flex max-w-7xl flex-col items-center gap-4 px-5 pt-15 pb-10 md:pt-20"
      >
      ...
      <article
        ref={articleMetaRef}
        className="invisible mx-auto flex max-w-7xl flex-col gap-8 px-5 py-10 md:gap-10 md:p-20 xl:flex-row xl:px-25 xl:pt-20"
      >
      ...
      <section className="mx-auto max-w-7xl px-5 md:px-20 xl:px-25">
        <div
          ...
          className="border-theme-200 invisible flex max-w-185 flex-col gap-10 border-t py-10 md:mx-auto md:pt-12 md:pb-20 xl:mx-0 xl:ml-auto"
        >
...
export default AnimatedJournalIdPage;

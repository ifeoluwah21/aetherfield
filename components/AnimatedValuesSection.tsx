...
const AnimatedValuesSection: FC = () => {
  ...
  useGSAP(() => {
    ...
    gsap.from(titleDivRef.current, {
      scrollTrigger: { trigger: titleDivRef.current, start: "top 80%" },
      y: "50px",
      autoAlpha: 0,
    });
  ...
  return (
    <section className="relative flex w-full flex-col gap-8 bg-[url(/footer-image.svg)] bg-cover bg-no-repeat px-5 py-10 md:gap-10 md:py-20 xl:py-30">
      ...
      <div
        ref={titleDivRef}
        className="invisible relative z-10 flex flex-col items-center"
      >
      ...
      <div
        ref={containerRef}
        className="invisible relative z-10 mx-auto flex max-w-310 flex-col gap-4 xl:flex-row"
      >
